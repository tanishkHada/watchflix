    ...
    return (
        <div className='w-full h-full'>
            ...
            <section className='relative h-screen w-full overflow-hidden'>
                ...
                bg-gradient-to-b from-[#ffffff00] to-[#1e293b]'>
                    ...
                    <div className='h-full w-full flex flex-col items-center justify-center p-10'>
                        ...
                        <div className='text-white mb-5 z-[15] pointer-events-none'
                            ...
                            <h1
                                ref={title}
                                className='text-center text-[50px] font-rockstar line-clamp-2 leading-[1.1]'
                            >{data[currentInd].title}</h1>
                        </div>

                        {/* sub details */}
                        <div className='flex justify-center items-center flex-wrap text-white font-extrabold'
                            style={{ fontKerning: 'none', clipPath: 'polygon(0 0, 100% 0, 100% 100%, 0% 100%)' }}
                        >
                        ...
                        <div className='text-white text-[15px] z-[15] pointer-events-none '>
                            <h1
                                ref={overview}
                                className='text-center font-montserrat-light line-clamp-[6]'
                ...
                <div className='changerBtn z-20 absolute transform translate-x-[-50%] left-[50%] bottom-20 bg-[var(--dark-void)] rounded-2xl px-2 py-1'
